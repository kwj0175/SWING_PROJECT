...
public class LoginView extends JPanel {
    ...
    public LoginView(MainScreen mainScreen, UserService userService) {
        this.mainScreen = mainScreen;
        this.userService = userService;
        this.loginPresenter = new LoginPresenter(this, userService);
    ...
    private void loginEvent() {
        ...
        signUpButton.addActionListener(e -> {
            SignUpView signUpView = new SignUpView(mainScreen, userService);
